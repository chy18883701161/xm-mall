...
public class Constants {
    // 上传文件的默认url前缀，根据部署设置自行修改，注意末尾要带斜杠
    // public final static String FILE_UPLOAD_DIC = "/opt/xm-mall/upload/";
    public final static String FILE_UPLOAD_DIC = "C:/Users/chy/Desktop/xm-mall/src/main/resources/upload/";
    ...
    public final static int SHOPPING_CART_ITEM_TOTAL_NUMBER = 100;//购物车中商品的最大数量(可根据自身需求修改)
